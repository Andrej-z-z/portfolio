...
const translations = {
  ...
  sr: {
    ...
    about_bio: [
      ...
      'Radim na preseku grafičkog dizajna, front-end razvoja i fotografije, sa stilom utemeljenim u brutalizmu i minimalizmu. Dizajniram jasne, strukturirane interfejse i gradim ih koristeći HTML, CSS i JavaScript, trenutno jačajući svoju osnovu u JS-u. Moj dizajnerski tok rada je zasnovan na Adobe paketu, sa jakim naglaskom na Photoshop, Illustrator i Lightroom.',
